...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      ...
      `
      // Usar requestAnimationFrame para aplicar estilos no próximo frame
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (whatsAppButton && buySection) {
        // Usar requestAnimationFrame para otimizar as operações de DOM
        requestAnimationFrame(() => {
    ...
    // Throttle scroll event para reduzir a frequência de chamadas
    let ticking = false
  ...
  return (
    <>
      ...
      <link rel="preconnect" href="https://emagrecedores-naturais.com" />
        ...
        <header className="w-full relative overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-800 via-green-700 to-green-800 py-3 shadow-md">
            ...
            <div className="mx-auto max-w-5xl px-4 flex justify-center">
              <Image src="/logo2.png" alt="Definamax" width={200} height={60} className="h-12 w-auto" priority />
            </div>
          </div>
              ...
              <div className="hidden md:block">
                ...
                >
                  <div className="bg-white p-6 rounded-lg border border-green-100 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p className="text-gray-700 mb-2">
                      "Oi, gente! Em 7 meses de Definamax, perdi 27kg! O melhor é que a fome sumiu e eu tenho uma
                  ...
                  <div className="bg-white p-6 rounded-lg border border-green-100 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p className="text-gray-700 mb-2">
                      "Meu sonho era emagrecer naturalmente, mas nada funcionava, nem injeção! Com Definamax, perdi 22
                      kg e tô chocada com o resultado no meu corpo. Finalmente eu consegui, depois de anos tentando."
                    </p>
                ...
                >
                  <div className="bg-white p-6 rounded-lg border border-green-100 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <p className="text-gray-700 mb-2">
                      "Comecei a tomar o Definamax há uns 4 meses e já perdi uns 15kg! Minha disposição melhorou demais
                      e tô conseguindo fazer umas provas de corrida sem cansar tanto"
                    </p>
            ...
            <div className="grid md:grid-cols-2 items-center gap-8">
              <div className="relative w-full h-0 pb-[56.25%]">
                ...
                <div className="absolute inset-0 w-full h-full">
                  ...
                  />
                  <iframe
                    src="https://player.vimeo.com/video/1082333298?autoplay=1&loop=1&background=1"
                    className="absolute top-0 left-0 w-full h-full"
                    frameBorder="0"
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-4 py-2 bg-green-50 rounded-r-lg">
                  ...
                  <p className="text-gray-700">
                    ...
                    digestão, impedindo que até 76% da gordura consumida seja absorvida pelo organismo. Essas gorduras
                    são eliminadas naturalmente, sem sobrecarregar o sistema digestivo.
                  </p>
                </div>
          ...
          <div className="mx-auto max-w-5xl px-4">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 p-6 rounded-lg border border-green-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-gray-700">
                  O Definamax é um suplemento alimentar devidamente registrado na Agência Nacional de Vigilância
                  Sanitária (ANVISA), garantindo que todos os ingredientes e processos de fabricação seguem os mais
              ...
              <div className="bg-green-50 p-6 rounded-lg border border-green-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-gray-700">
                  Estamos tão confiantes na eficácia do Definamax que oferecemos uma garantia incondicional de 30 dias.
                  Se você não estiver completamente satisfeito com os resultados, basta entrar em contato conosco para
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    cerveja no final de semana. Praticamente a barriga que eu tinha era toda de cerveja, e o Definamax
                    me ajudou muito com isso, perdi aquela barriga, e ainda posso tomar umas no sabádo de futebol.
                    Aprovado.
                  </p>
                  <div className="flex gap-2 mb-4">
                    <Image
                ...
                <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    Definamax foi a única coisa que realmente funcionou para mim sem efeitos colaterais. Em 3 meses
                    perdi 14kg e minha pressão arterial normalizou. Estou muito feliz com os resultados!
                  </p>
                  <div className="flex gap-2 mb-4">
                    <Image
                      src="/2depois.png"
                ...
                <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    sucesso. Com o Definamax, perdi 10kg em 2 meses e meio! O melhor é que não sinto aquela ansiedade
                    por comida que tinha antes. Minha autoestima voltou!
                  </p>
                  <div className="flex gap-2 mb-4">
                    <Image
                      src="/revi3.jpeg"
                ...
                <div className="border border-gray-200 rounded-lg p-6 hover:border-green-200 hover:shadow-md transition-all">
                  ...
                  <p className="text-gray-700 mb-4">
                    ...
                    sem resultado. Com o Definamax, perdi 13kg no segundo mês! Minha barriga diminuiu visivelmente e
                    minha energia aumentou. Já recomendei para todos os meus amigos.
                  </p>
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full bg-green-100 overflow-hidden mr-2">
                      <Image
              ...
              {showMoreReviews && (
                <div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                    ...
                    <p className="text-gray-700 mb-4">
                      Eu estava com pré-diabetes e meu nutricionista sugeriu que eu perdesse peso urgentemente. Comecei
                      a tomar Definamax e em 3 meses perdi 16kg! Na última consulta, meus exames voltaram ao normal e
                      meu médico perguntou o que eu tinha feito. Recomendo a todos!
                    </p>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-green-100 overflow-hidden mr-2">
                        <Image
                  ...
                  <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      Definamax para ajudar e tem funcionado perfeitamente. Não recuperei nenhum kg nos últimos 3 meses
                      e tenho me sentido muito bem!
                    </p>
                    <div className="flex gap-2 mb-4">
                      <Image
                        src="/revi6.jpeg"
                  ...
                  <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                    ...
                    <p className="text-gray-700 mb-4">
                      ...
                      Definamax e em 2 meses perdi 9kg! Consegui usar meu vestido e me senti maravilhosa. As fotos
                      ficaram incríveis e me sinto confiante com meu corpo novamente. Ainda preciso emagrecer mais, eu
                      sei. Mas estou bem satusfeita.
                    </p>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-green-100 overflow-hidden mr-2">
                        <Image
                  ...
                  <div className="border border-gray-200 rounded-lg p-6 mb-6 hover:border-green-200 hover:shadow-md transition-all">
                    ...
                    <p className="text-gray-700 mb-4">
                      Depois de ganhar peso na pandemia, nenhuma das minhas calças servia mais. Minha esposta estava
                      muito incomodada com isso, achei que iria me separar. Comecei a tomar Definamax e em 1 mês já
                      perdi 5kg! As coisas começaram a melhorar em casa. É responsabilidade minha eu ter engordado
                      tanto, e também é responsabilidade minha emagrecer.
                    </p>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-green-100 overflow-hidden mr-2">
                        <Image
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  ...
                  gordura, aumentar a saciedade e acelerar o metabolismo. Ele funciona como um detox poderoso,
                  promovendo resultados rápidos e visíveis em poucas semanas.
                </div>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  Recomenda-se utilizar 2 cápsulas de Definamax por dia, preferencialmente antes das principais
                  refeições, com um copo de água. Para obter os melhores resultados, utilize o produto de forma contínua
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  O prazo de entrega do Definamax varia de acordo com a sua região, mas geralmente é de 5 a 10 dias
                  úteis. Oferecemos uma garantia de satisfação de 30 dias. Se você não estiver satisfeito com os
                  resultados, basta entrar em contato conosco para receber 100% do seu dinheiro de volta.
                </div>
              </div>
            </div>
        ...
        <footer className="w-full py-8 bg-green-800 text-white">
          <div className="mx-auto max-w-5xl px-4 text-center">
            ...
            <p className="text-xs text-gray-300 mb-4">
              *Resultados podem variar de pessoa para pessoa. Este produto não se destina a diagnosticar, tratar, curar
              ou prevenir qualquer doença. Consulte sempre um profissional de saúde qualificado antes de iniciar
