      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex md:hidden justify-between items-center">
          ...
          <button 
            ...
            className="bg-green-700 hover:bg-green-800 text-white px-5 py-2.5 rounded font-bold text-sm border border-white shadow-2xl hover:shadow-green-700/25 transform hover:scale-110 hover:-translate-y-1 transition-all duration-300 relative z-10 hover:border-green-300"
          >
            COMPRAR AGORA
          </button>
        </div>
