...
export default function DefinamaxFAQ() {
  ...
  const toggleFaq = (faqId: string) => {
    setOpenFaqs((prev) => ({
      ...prev,
      [faqId]: !prev[faqId as keyof typeof prev],
    }))
  }
                  ...
                  >
                    <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4 mb-6">
                      ...
                      <ul className="space-y-2">
                        ...
                        {/* Kit 8 meses */}
                        <div className="bg-white rounded-3xl shadow-lg overflow-hidden border-2 border-green-600 max-w-md">
                        <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 text-white text-center">
                          <h3 className="text-2xl font-bold">COMPRE 5 LEVE 8 FRASCOS</h3>
                          <p className="text-xl">GANHE O E-BOOK + APP</p>
                        </div>
                        
                        <div className="bg-[#e8f5e9] p-4 text-center">
                          <p className="text-xl font-semibold text-gray-800">Tratamento para 8 meses</p>
                        </div>
                        ...
                        <div className="p-6">
                          ...
                          <div className="bg-[#e8f5e9] py-3 text-center mb-6">
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <span className="text-lg font-medium">FRETE GRÁTIS</span>
                            </div>
                          </div>

                          <Link
                            href={addUtmToUrl("https://full.sale/ytA47b")}
                            className="block w-full py-4 px-6 text-center text-xl font-bold text-white bg-gradient-to-r from-green-500 to-green-600 rounded-full hover:from-green-600 hover:to-green-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                          >
                            COMPRAR AGORA
                          </Link>
                          ...
                          <div className="flex justify-center items-center gap-8 mt-6">
                            <div className="text-center">
                              ...
                              <p className="text-sm font-medium text-gray-600">Compra<br/>Segura</p>
                            </div>
                            ...
                            <div className="text-center">
                              ...
                              <p className="text-sm font-medium text-gray-600">Satisfação<br/>Garantida</p>
                            </div>
                            
                            <div className="text-center">
                              <div className="flex items-center justify-center mb-1">
                                <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8V7m-6 4h2" />
                                </svg>
                              </div>
                              <p className="text-sm font-medium text-gray-600">Privacidade<br/>Protegida</p>
                            </div>
                          </div>
                                              </div>
                        </div>
