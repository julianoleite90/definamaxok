...
const RemarketingPage2 = () => {
  ...
  const scrollToKits = () => {
    ...
    const finalUrl = addUtmToUrl('https://full.sale/45BmdK?src=rmkt-2');
  ...
  return (
    <>
    <Helmet>
      <title>Track 2 - Definamax - Vídeos Exclusivos | Descubra Como Emagrecer Naturalmente</title>
    </Helmet>
...
export default RemarketingPage2; 